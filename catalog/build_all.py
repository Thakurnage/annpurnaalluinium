    ...
    <a href="#" class="flex items-center gap-2.5 sm:gap-3 group" aria-label="Annapurna Aluminium Homepage">
      <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 via-cyan-500 to-amber-500 p-0.5 shadow-lg group-hover:scale-105 transition-transform flex-shrink-0">
        <div class="w-full h-full bg-slate-950 rounded-[10px] flex items-center justify-center">
          <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            <defs>
              <linearGradient id="brandLogoGrad" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stop-color="#34d399"/><stop offset="52%" stop-color="#22d3ee"/><stop offset="100%" stop-color="#fbbf24"/>
              </linearGradient>
            </defs>
            <path d="M3 21h18" stroke="url(#brandLogoGrad)"/>
            <path d="M5 21V6.2a1 1 0 0 1 .62-.93l7-2.8a1 1 0 0 1 1.38.92V21" stroke="url(#brandLogoGrad)"/>
            <path d="M14 21V9.6h4.4a1 1 0 0 1 1 1V21" stroke="url(#brandLogoGrad)"/>
            <path d="M8 8.4h3M8 11.6h3M8 14.8h3M8 18h3M16.2 13h1.4M16.2 16.4h1.4" stroke="url(#brandLogoGrad)"/>
          </svg>
        </div>
      </div>
      <div>
    ...
    <div class="space-y-3">
      <div class="flex items-center gap-2.5">
        <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-emerald-500 via-cyan-500 to-amber-500 p-0.5 shadow-lg flex-shrink-0">
          <div class="w-full h-full bg-slate-950 rounded-[10px] flex items-center justify-center">
            <svg class="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <defs><linearGradient id="footLogoGrad" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34d399"/><stop offset="52%" stop-color="#22d3ee"/><stop offset="100%" stop-color="#fbbf24"/></linearGradient></defs>
              <path d="M3 21h18" stroke="url(#footLogoGrad)"/>
              <path d="M5 21V6.2a1 1 0 0 1 .62-.93l7-2.8a1 1 0 0 1 1.38.92V21" stroke="url(#footLogoGrad)"/>
              <path d="M14 21V9.6h4.4a1 1 0 0 1 1 1V21" stroke="url(#footLogoGrad)"/>
              <path d="M8 8.4h3M8 11.6h3M8 14.8h3M8 18h3M16.2 13h1.4M16.2 16.4h1.4" stroke="url(#footLogoGrad)"/>
            </svg>
          </div>
        </div>
        <div>
